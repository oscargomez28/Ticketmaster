...
public interface  IOperacionesWeb {
	 ...
	 * IMPORTANTE: La implementacion de este metodo deberá ser marcado como SYNCRONYZED. hecho
	 * 
	 ...
	 * IMPORTANTE: La implementación de este método deberá ser marcado como synchronized. hecho
	 *
